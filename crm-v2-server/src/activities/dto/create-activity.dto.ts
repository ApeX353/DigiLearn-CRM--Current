...
export class CreateActivityDto {
  ...
  @ApiPropertyOptional({
    ...
    description:
      'For "log a past interaction" creates that arrive with status=completed: the outcome of the interaction. Ignored for scheduled creates.',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description:
      'Free-form account of how the completed interaction went. Ignored for scheduled creates.',
    maxLength: 2000,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    type: [String],
    description:
      '"This also covered…": ids of OPEN activities on the same lead/deal/contact that this logged interaction settled (e.g. the scheduled meeting that actually took place). Only honoured on status=completed creates; they are completed in the same transaction with the same outcome and a note pointing back at this activity. Max 20.',
  })
  @IsOptional()
  @IsArray()
  @ArrayMaxSize(20)
