...
import { SetSettingDto, BulkSetSettingsDto } from './dto/set-setting.dto';
...
export class SettingsController {
  ...
  async setSettings(@Body() body: BulkSetSettingsDto) {
    const result = await this.settingsService.setSettings(body.settings);
    return {
      success: true,
