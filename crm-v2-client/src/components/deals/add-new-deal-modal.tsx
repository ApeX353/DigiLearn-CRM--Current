      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 space-y-4 border-r pr-6 border-border">
            ...
            {/*
              Commercial intent. The server only demands this when the
              compliance switch is on AND the lead has not already earned
              intent from a recorded signal, so it stays optional here and
              the 400 tells the rep when it is needed. Whatever is typed is
              stored on the lead and written to the audit log.
            */}
            <FormField
              control={form.control}
              name="commercial_intent_reason"
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Why is this commercially live?{" "}
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="e.g. Head confirmed budget approved for 4 boards this term"
