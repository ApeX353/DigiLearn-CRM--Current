    ...
    <div className="space-y-4" data-testid="compliance-controls-content">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          {/* Auto-assign engine — admin + admin_support (which mirrors admin
              app-wide, and is the account that actually opens Settings). 6.10:
              was ["admin"] only, so admin_support could open the page but never
              see this toggle. */}
          <FeatureGuard allowedRoles={["admin", "admin_support"]}>
            <div className="flex flex-col gap-4 rounded-md border p-4 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
              <div className="space-y-1">
                <Label
