...
export interface CompletionRequest {
  ...
  onCancelled?: () => void;
  /**
   * Bulk mode: complete several activities at once with one quick outcome
   * and a single honest canned note. The dialog restricts itself to quick
   * outcomes when this is set with more than one id.
   */
  bulkIds?: string[];
}
